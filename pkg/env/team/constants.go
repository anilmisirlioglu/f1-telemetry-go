...
const (
	...
	Charouz2020             uint  = 73
	Dam2020                 uint  = 74
	UniVirtuosi2020         uint  = 75
	MPMotorsport2020        uint  = 76
	Prema2020               uint  = 77
	Trident2020             uint  = 78
	BWT2020                 uint  = 79
	Hitech2020              uint  = 80
	Mercedes2020            uint  = 85
	Ferrari2020             uint  = 86
	RedBull2020             uint  = 87
	Williams2020            uint  = 88
	RacingPoint2020         uint  = 89
	Renault2020             uint  = 90
	AlphaTauri2020          uint  = 91
	Haas2020                uint  = 92
	McLaren2020             uint  = 93
	AlfaRomeo2020           uint  = 94
	Prema2021               uint  = 106
	UniVirtuosi2021         uint  = 107
	Carlin2021              uint  = 108
	Hitech2021              uint  = 109
	ArtGP2021               uint  = 110
	MPMotorsport2021        uint  = 111
	Charouz2021             uint  = 112
	Dams2021                uint  = 113
	Campos2021              uint  = 114
	BWT2021                 uint  = 115
	Trident2021             uint  = 116
	MyTeam                  uint8 = 255
)
